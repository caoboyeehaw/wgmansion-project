  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen ">
      <div className="flex items-center mb-4">
        <div className="mr-2 text-zinc-800 text-5xl font-black font-bombardier italic antialiased">LLM</div>
        <div className="mr-1 text-zinc-800 text-4xl font-bold px-2 py-0.5 bg-pink-200 rounded-lg">Trader</div>
